...
public class CuentaManager {
    ...
    public List<Cuenta> buscarTodas() {
        ...
        Query query = session.createNativeQuery("SELECT * FROM persona", Cuenta.class);
    ...
    public List<Cuenta> buscarPor(String nombre) {
        ...
        //como nombre: "' or '1'='1"
        Query query = session.createNativeQuery("SELECT * FROM persona where nombre = '"+nombre+"'", Cuenta.class);
